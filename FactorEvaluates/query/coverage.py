...
CHART_SPECS: Tuple[Dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "prefixes": (
            "quantile_returns_",
            "quantile_returns_after_cost_",
            "quantile_ic_",
            "quantile_rank_ic_",
            "quantile_top_hit_",
            "quantile_bot_hit_",
            "quantile_factor_mean_",
        ),
        "metrics": (
            "quantile",
            "quantile_returns_after_cost",
            "quantile_ic",
            "quantile_rank_ic",
            "quantile_return_hit",
            "quantile_factor_mean",
        ),
    },
    {
        "id": "turnover",
    ...
    },
    {
        "id": "monotonicity",
        "title": "单调性（分组均收益）",
        "prefixes": ("quantile_returns_", "quantile_factor_mean_"),
        "metrics": ("quantile", "quantile_factor_mean"),
    },
    {
        "id": "consistency",
        "title": "长短窗一致性",
    ...
    },
    {
        ...
        "metrics": ("coverage_rate", "missing_samples", "total_samples"),
    },
    {
        "id": "factor_stats",
        "title": "截面分布",
        ...
        "metrics": ("factor_stats", "factor_min", "factor_max"),
    },
    {
        "id": "factor_autocorr",
        "title": "因子自相关",
    ...
    },
    {
        ...
        "title": "风格秩相关",
        "prefixes": (
            "factor_style_correlation_",
            "barra_corr_Q",
            "long_short_barra_corr_",
            "barra_exposure_Q",
            "long_short_barra_exposure_",
        ),
        "metrics": (
            "factor_style_correlation",
            "barra_quantile_correlation",
            "long_short_barra_corr",
            "long_short_barra_exposure",
        ),
    },
    {
        "id": "barra_exposure",

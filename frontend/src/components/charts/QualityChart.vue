...
const quality = computed(() =>
  pickSeries(props.series, ["coverage_rate", "missing_rate", "unique_rate", "extreme_value_ratio", "iqr"], {
    coverage_rate: "覆盖率",
    missing_rate: "缺失率",
    unique_rate: "唯一值比例",
...
const dist = computed(() =>
  pickSeries(props.series, ["factor_mean", "factor_std", "factor_median", "factor_skewness", "factor_kurtosis"], {
    factor_mean: "截面均值",
    factor_std: "截面波动",
    factor_median: "截面中位数",
    factor_skewness: "偏度",
